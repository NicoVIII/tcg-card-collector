...
/// A persistence failure's fixed client-facing message. AddCards and
/// ImportCollection build this inline on both transports today (issue #87
/// judged collection exempt from writing error presentation once per use
/// case, since collection's skir side returns typed rejection variants
/// instead of errors) — but that reasoning doesn't cover this arm: both
