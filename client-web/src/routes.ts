...
export const routes: AppRoute[] = [
    ...
    { path: "/inventory", label: "Inventory", description: "Inventory planning and grouping will live here." },
    { path: "/settings", label: "Settings", description: "Runtime settings and manual refresh will live here." }
];
