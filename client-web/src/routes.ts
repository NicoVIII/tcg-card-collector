...
export type AppRoute = {
  path: "/collection" | "/backup" | "/catalog" | "/inventory" | "/placement" | "/insights";
  label: string;
  component: Component;
};
...
// All routable pages; setup pages like backup live here but stay out of the
// nav and are reached via in-page links instead.
