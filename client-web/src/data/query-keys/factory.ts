...
export const queryKeys = {
  catalogList: (filter: CardFilter, offset: number, limit: number) =>
    ["card_catalog", "list", filter.name, filter.set_code, offset, limit] as const,
  ...
  appVersion: () => ["system", "app_version"] as const,
};
